      ...
      <div style={{background:"#1a1a2e",border:"1px solid rgba(255,215,0,0.25)",borderRadius:"16px",padding:"2rem",maxWidth:"420px",width:"100%",position:"relative"}} onClick={e=>e.stopPropagation()}>
        ...
        {submitted ? (
          ...
          <>
            ...
            {[
              {k:"name" as const,label:"your name",ph:"John Doe",t:"text"},
              {k:"email" as const,label:"your email",ph:"john@email.com",t:"email"},
              {k:"time" as const,label:"preferred time",ph:"e.g. Saturday afternoons",t:"text"},
              {k:"place" as const,label:"preferred place",ph:"e.g. Crystal City Sports Pub",t:"text"}
            ].map(f=>(
