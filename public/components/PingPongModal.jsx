...
export default function PingPongModal({ onClose }) {
            ...
            {[
              ...
              <div key={f.k} style={{marginBottom:"0.9rem"}}>
                ...
                <input 
                  ...
                  style={{width:"100%",background:"rgba(255,255,255,0.06)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:"8px",padding:"9px 12px",color:"#fff",fontFamily:"'DM Sans', sans-serif",fontSize:"14px",outline:"none",boxSizing:"border-box"}}
                />
              </div>
            ))}
            
            <button 
              onClick={()=>{if(form.name&&form.email&&form.time&&form.place)setSubmitted(true);}} 
              style={{width:"100%",background:"#FFD700",border:"none",borderRadius:"8px",padding:"11px",color:"#0f0f14",fontFamily:"'DM Sans', sans-serif",fontSize:"14px",fontWeight:700,cursor:"pointer",marginTop:"0.25rem"}}
            >
              send challenge 🏓
            </button>
          </>
