...
export const LegoBlock = ({ color, x, y, size = 1, delay = 0 }: LegoBlockProps) => {
  ...
  return (
    <div
      style={{
        ...
        top: y,
        opacity: visible ? 1 : 0,
        transform: visible ? 'translateY(0) rotate(0deg)' : 'translateY(-40px) rotate(-15deg)',
        transition: `opacity 0.6s ${delay}ms, transform 0.6s ${delay}ms cubic-bezier(0.34,1.56,0.64,1)`,
      }}
    >
